...
This project summarizes the latest news or YouTube videos on any topic by leveraging generative AI to provide concise, accurate digests of complex information.
Problem
...
Gen AI Capabilities
Few-shot Prompting & Structured Output : Summarization of a news article excerpt with few-shot prompting.
Video Understanding : Summarization of a YouTube video using the Gemini Pro model.
Retrieval augmented generation (RAG) : Building a Q&A chatbot leveraging RAG to provide informed answers based on a video summary.
